...
from core.domain.usecases.reservation.create_reservation_use_case import (
    CreateReservationUseCase,
)
from core.domain.usecases.reservation.update_reservation_use_case import (
    UpdateReservationUseCase,
)
from core.domain.usecases.reservation.list_reservations_use_case import (
    ListReservationsUseCase,
)
from core.domain.usecases.reservation.list_reservations_by_status_use_case import (
    ListReservationsByStatusUseCase,
)
from core.domain.usecases.reservation.checkin_reservation_use_case import (
    CheckinReservationUseCase,
)
from core.domain.usecases.reservation.checkout_reservation_use_case import (
...
class ReservationController:
    def __init__(self):
        ...
        self._update_reservation_use_case = UpdateReservationUseCase(
            self._reservation_repository, self._room_repository
        )
        self._list_reservations_use_case = ListReservationsUseCase(
            self._reservation_repository
        )
        self._list_reservations_by_status_use_case = ListReservationsByStatusUseCase(
            self._reservation_repository
        )
        self._checkin_reservation_use_case = CheckinReservationUseCase(
            self._reservation_repository
        )
        self._checkout_reservation_use_case = CheckoutReservationUseCase(
            self._reservation_repository
        )
    ...
    def list_reservations_by_status(
